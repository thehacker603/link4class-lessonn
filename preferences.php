...
$subjects_map = [
    ...
    'Liceo Scienze Applicate' => [
       1 => ['italiano', 'storia', 'inglese', 'matematica', 'informatica', 'geografia', 'scienze naturali','arte','chimica','fisica','filosofia'],
        2 => ['italiano', 'storia', 'inglese', 'matematica', 'informatica', 'geografia', 'scienze naturali','arte','chimica','fisica','filosofia'],
       3 => ['italiano', 'storia', 'inglese', 'matematica', 'informatica', 'geografia', 'scienze naturali','arte','chimica','fisica','filosofia'],
        4 => ['italiano', 'storia', 'inglese', 'matematica', 'informatica', 'geografia', 'scienze naturali','arte','chimica','fisica','filosofia'],
        5=> ['italiano', 'storia', 'inglese', 'matematica', 'informatica', 'geografia', 'scienze naturali','arte','chimica','fisica','filosofia'],
    ],
    'Istituto Socio-Sanitario' => [
        ...
        3 => ['italiano', 'storia', 'inglese', 'matematica','spagnolo','metodologie operative','diritto','igiene','psicologia'],
        4 => ['italiano', 'storia', 'inglese', 'matematica','spagnolo','metodologie operative','diritto','igiene','psicologia'],
        5 => ['italiano', 'storia', 'inglese', 'matematica','spagnolo','metodologie operative','diritto','igiene','psicologia'],
    ],
];

// Scegli le materie per questa classe/indirizzo
$subjects = $subjects_map[$school_track][$school_class]
...
<body>
  <div style="width:100%; max-width:600px;">
    <h1>Preferenze per <?= htmlspecialchars("{$school_class}ª {$school_track}") ?></h1>
  ...
  <script>
    // Mostra/nascondi fieldset descrizione
