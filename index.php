...
<body class="bg-[#0a0b10] text-white min-h-screen relative">
  ...
  <!-- CTA -->
  <section id="cta" class="relative py-28">
    <div aria-hidden class="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      <div class="absolute -top-40 left-1/2 h-[50rem] w-[50rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(99,102,241,0.25),transparent_60%)] blur-3xl"></div>
      <div class="absolute -bottom-40 left-1/3 h-[40rem] w-[40rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.18),transparent_60%)] blur-3xl"></div>
    </div>
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="js-tilt mx-auto max-w-4xl relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-0.5 backdrop-blur-md">
        <div class="pointer-events-none absolute inset-0 -z-10 rounded-3xl bg-gradient-to-br from-indigo-500/25 via-white/10 to-emerald-400/25 opacity-30"></div>
        <span aria-hidden class="ring-gradient"></span>
        <div class="tilt-inner relative rounded-[calc(theme(borderRadius.3xl)-2px)] bg-gradient-to-b from-white/10 to-white/[0.04]">
          <div class="relative overflow-hidden rounded-[inherit] p-10 text-center">
            <span aria-hidden class="card-sheen"></span>
            <div class="absolute inset-0 -z-10 bg-gradient-to-br from-indigo-500/20 via-emerald-400/10 to-transparent"></div>
            <h2 class="text-3xl font-bold text-white sm:text-4xl">Pronto a lanciare il tuo campus?</h2>
            <p class="mx-auto mt-3 max-w-2xl text-white/70">Crea il tuo spazio, invita il team e pubblica la prima lezione oggi. Gratis, senza carta.</p>
            <div class="mt-6 flex justify-center gap-3">
              <button class="js-magnetic btn-ripple group relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-500 to-emerald-400 px-6 py-3 text-white shadow-xl"><a href="link4class/register.php">Crea account</a> <i data-lucide="arrow-right" class="h-4 w-4 inline-block"></i></button>
            </div>
            <span aria-hidden class="pointer-events-none absolute -inset-10 opacity-[var(--lg-caustic)] [mask-image:radial-gradient(40%_35%_at_50%_0%,black,transparent)]" style="background:radial-gradient(70rem 36rem at 10% -10%, rgba(255,255,255,0.12), transparent 60%), radial-gradient(50rem 30rem at 110% 120%, rgba(255,255,255,0.10), transparent 65%);mix-blend-mode:screen;filter:blur(var(--lg-blur))"></span>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="relative border-t border-white/10 py-10 text-sm text-white/60">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between gap-6 sm:flex-row">
      ...
      <div class="flex gap-6">
        ...
        <a href="#" class="transition hover:text-white">Termini</a>
        <a href="#" class="transition hover:text-white">Contatti</a>
      </div>
    </div>
  </footer>
